...
class PlayState extends MusicBeatState
{
	...
	public static var ratingStuff:Array<Dynamic> = [
		['FUCK OFF!', 0.2], //From 0% to 19%
		['Shitty', 0.4], //From 20% to 39%
		['Skill Issue', 0.5], //From 40% to 49%
		['Bruh', 0.6], //From 50% to 59%
		['Meh', 0.69], //From 60% to 68%
		['jeje funi namber', 0.7], //69%
		['VODAFONE', 0.8], //From 70% to 79%
		['A', 0.9], //From 80% to 89%
		['CAMBIATE!', 1], //From 90% to 99%
		['Mario AtsApUmPum', 1] //The value on this one isn't used actually, since Perfect is always "1"
	];
	...
	override public function create()
	{
		...
		{
			case 'vodafone':
				stageFront = new BGSprite('vodafondo', -3165, -85, 0.9, 0.9, ['fondo'], true);
